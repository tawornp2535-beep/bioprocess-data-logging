...
function App() {
  ...
  const SURVEY_QUESTIONS = [
    ...
    { id: 'q12', section: 'ระบบติดตามและบันทึกข้อมูล (SCADA DBMS)', text: 'ระบบติดตามข้อมูลเรียลไทม์ (Real-time Dashboard) ช่วยให้ท่านเห็นสถานะการทำงานได้อย่างสะดวก รวดเร็ว' },
    { id: 'q13', section: 'ระบบติดตามและบันทึกข้อมูล (SCADA DBMS)', text: 'โหมดการนำเสนอข้อมูล (Presentation Mode) และกราฟวิเคราะห์มีความสวยงาม ชัดเจน และใช้งานง่าย' },
  ];
